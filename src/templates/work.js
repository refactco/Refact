...
const WorkPage = ({data}) => {
  ...
  const heroSection = workContent.find(section => section.fieldGroupName === 'Template_PageBuilder_Pagebuilder_PageBuilder_PageHeader');
  const featuredPost = workContent.find(section => section.fieldGroupName === 'Template_PageBuilder_Pagebuilder_PageBuilder_FeaturedPost');
  const featuredTestimonial = workContent.find(section => section.fieldGroupName === 'Template_PageBuilder_Pagebuilder_PageBuilder_FeaturedTestimonial');
  const projectSection = workContent.find(section => section.fieldGroupName === 'Template_PageBuilder_Pagebuilder_PageBuilder_Project');
  const clientSection = workContent.find(section => section.fieldGroupName === 'Template_PageBuilder_Pagebuilder_PageBuilder_Clients');
  const textButton = workContent.find(section => section.fieldGroupName === 'Template_PageBuilder_Pagebuilder_PageBuilder_TextButton');
    ...
    <Layout>
      {heroSection && (
        ...
        <div className="c-page-header is-full">
          ...
          <div className="c-page-header__text" dangerouslySetInnerHTML={{__html:heroSection.text}} style={{maxWidth: 796}}></div>
          {heroSection.cta && (
      ...
      {clientSection && (
        ...
        <div className="c-client">
          ...
          {clientSection.description && (
            <div className="c-client__text" dangerouslySetInnerHTML={{__html:clientSection.description}}></div>
          )}
          {clientSection.showClientLogos && (
            <AboutLogo />
          )}
        </div>
      </ContainerBox>
        ...
        <ContainerBox className="c-section--textbutton is-work">
          <div className="c-team">
            ...
            {textButton.description && (
              <div className="c-team__description" dangerouslySetInnerHTML={{__html:textButton.description}}></div>
            )}
            {textButton.cta && (
