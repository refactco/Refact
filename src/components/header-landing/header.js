...
const HeaderLanding  = () => {
  ...
  const mobileNavClassName = `o-section c-section--header is-landing js-navigation`;
  return (
    <>
    <header className={mobileNavClassName}>
      <div className="o-section__wrapper">
        <div className="c-header">
          ...
          <div className="c-header__col">
            <ul className='c-header-landing__nav'>
              <li>
                <Link to="/">
                  Refact.co
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" fill="none" viewBox="0 0 20 20"><path fill="currentColor" d="M15.833 10.833v5a1.667 1.667 0 0 1-1.666 1.667h-10A1.667 1.667 0 0 1 2.5 15.833v-10a1.667 1.667 0 0 1 1.667-1.666h5v1.666h-5v10h10v-5h1.666Zm-5-8.333v1.667h3.822L8.161 10.66l1.178 1.178 6.494-6.494v3.822H17.5V2.5h-6.667Z"/></svg>
                </Link>
              </li>
              <li>
                <>
